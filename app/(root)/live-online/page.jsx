                  ...
                  <div className="courseTab">
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                      <li className="nav-item">
                        <a className="nav-link active" id="profile-tab" data-bs-toggle="tab" href="#mission" role="tab">Add/edit courses</a>
                      </li>
                      <li className="nav-item">
                          ...
                          <div className="resumeCard">
                            <div className="form-group col-12">
                              ...
                              <div className="newAddDelete">
                                ...
                                <Link href="" data-bs-toggle="modal" data-bs-target="#create-live-session" className="btnBorder plusAdd"> <Image src={plusIcon} alt="plusIcon" /> Live session </Link>
                                <Link href="" className="btnBorder plusAdd"> <Image src={plusIcon} alt="plusIcon" /> quiz</Link>
                                <Link href="" className="btnBorder plusAdd"> <Image src={plusIcon} alt="plusIcon" /> Additional Materials</Link>
                              </div>
                            </div>
                            ...
                            <div className="courseQuiz">
                              ...
                              <div className="form-group mt-3 col-12">
                                ...
                                <input type="text" className="form-control" placeholder="Write question" />
                              </div>

                              <div className="learnAbout">
                                <label className="subTitle">Select Answer</label>
                            ...
                            <div className="formBtn">
                              <a href="" className="btnBorder">Cancel</a>
                              <a href="" className="btnGradient">Confirm</a>
                            </div>
                          </div>

                          <a href="" className="btnBorder plusAdd"> <Image src={plusIcon} alt="plusIcon" /> Add New Section</a>
