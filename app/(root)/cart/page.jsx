        ...
        <div className="row">
            ...
            <div className="courseDetailWrap mycartLeft">
              ...
              <div className="courseConatnt">
                ...
                <ul className="course-review">
                  ...
                  <li>
                    <span className="hour-min">1 Hr</span>
                  </li>
                ...
                <div className="remove">
                  <Link href="#" className="removeIcon">
                    Remove
                  </Link>
                </div>
              </div>
          ...
          <div className="col-lg-4 col-md-5 col-sm-12 order-1 order-lg-2">
            <div className="cartRight">
              ...
              <Link href="#" className="viewOffer">
                View Available Offers
              </Link>

              <div className="checkouSubTotal">
                <span className="subtotal">Subtotal</span>
                <span className="subTotalAed">
                  AED75{" "}
                  <span className="off-price">
                    <span>AED 60</span> 10% off
                  </span>
                </span>
              </div>
              ...
              <div className="vatTotal">
                <span className="vat">
                  VAT<span>(5% of the above value)</span>
                </span>
            ...
            <div className="cartNote">
              ...
              turpis molesm sollicitudin lacus,
            </div>
          </div>
        </div>
      </div>
