...
import { resetPassword } from "@/app/features/student/auth/authService";
            ...
            <div className="log_wraps">
              ...
              <div className="log__heads">
                <h4 className="logs_title">
                  {student?.student_reset_password_title || "Set a password"}
                </h4>
                {<p>{student?.student_reset_password_description} </p> || (
